...
<section class="main-section paddind" id="Portfolio">
	...
	<div class="c-logo-part" style=" width:1179px; background-image: url('img/pw_maze_black.png');">
		<!--c-logo-part-start-->
		<div class="container">      
        <form action="testing.php" method="get"style="display: inline-block;">
        	<table>
        		<tr>
        			<td>
        	...
        	</td><td><a  style="margin-left: 10px;"class="btn btn-primary" href="tambah-test.php">Tambah</a>
        	</td><td><a style="margin-left: 630px;"class="btn btn-danger" href="saw.php">Perangkingan</a>
        	</td></table>
        </form>
    </div>
    </div>
                ...
                <thead>
                  <tr>
                   ...
                   <tbody>
                        ...
                        ?>  <td><a class="btn btn-primary" href="edit-test.php?id=<?php echo $id_responden; ?>">edit</a></td>
                            <td><a class="btn btn-danger" href="testing/hapus.php?id=<?php echo $id_responden; ?>">delete</a></td></tr><?php
						}else{
							$word = ucfirst($cari);
							$wrd = lcfirst($cari);
