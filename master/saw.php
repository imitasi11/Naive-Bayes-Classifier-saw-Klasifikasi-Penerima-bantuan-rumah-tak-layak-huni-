...
<body>
	...
	<section class="main-section paddind" id="Portfolio">
		...
		<div class="container" style="margin-top: -50px;">
			<h2>Simple Adective Weight</h2>
			<h6>Perangkingan Data</h6>
			<div class="c-logo-part" style=" width:1179px; background-image: url('img/pw_maze_black.png');">
		<!--c-logo-part-start-->
		<div class="container" align="right">      
        	<a align="right" class="btn btn-danger" href="print.php">Print Preview</a>
    	</div>
    </div>
    	<div class="table-responsive" style="width: 1179px;">

	<div style="height: 370px;overflow-y: scroll;" id="div1">
